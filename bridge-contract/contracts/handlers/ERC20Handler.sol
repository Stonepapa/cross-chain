    ...
    */
    ...
    function deposit(
        ...
        if (_burnList[tokenAddress]) {
            ...
            require(value == 0, "invalid msg.value");
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        ...
        if (_burnList[tokenAddress]) {
            ...
            releaseETH(payable(address(recipientAddress)), amount);
        } else {
     ...
     */
    function withdrawETH(address payable recipient, uint256 amount) external override onlyBridge {
